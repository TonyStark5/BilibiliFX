...
public class HttpHeaders {
	...
	public HttpHeaders() {
		UA_PC = "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:93.0) Gecko/20100101 Firefox/93.0";
	}
	...
	public HashMap<String, String> getBiliAppJsonAPIHeaders() {
		...
		headerMap.put("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.119 Safari/537.36");
		headerMap.put("X-Requested-With", "ShockwaveFlash/28.0.0.137");
		return headerMap;
	}
	 ...
	 */
	public HashMap<String, String> getAllFavListHeaders(String personId) {
		...
		headerMap.put("Referer", String.format("https://space.bilibili.com/%d/favlist", Long.getLong(personId)));
		headerMap.put("User-Agent", UA_PC);
		return headerMap;
	}
